...
const thaneHero = "/assets/Thane-hero-DrOVl4ce.png";
const thaneHeroMobile = "/assets/Thane-hero-mobile-Dy9Dmsva.png";
const visitImg = "/assets/6-CFXD9DOa.png";
function ThaneBranch() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col bg-white", children: [
    /* @__PURE__ */ jsxs("section", { className: "hidden sm:flex relative w-full min-h-[620px] lg:h-[660px] bg-white items-center overflow-hidden border-b border-neutral-100", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "relative max-w-7xl mx-auto w-full px-6 sm:px-8 md:px-12 z-20 py-16 lg:py-0", children: /* @__PURE__ */ jsxs("div", { className: "max-w-[580px] lg:max-w-[650px] text-left flex flex-col space-y-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-xs sm:text-[13px] font-sans font-medium text-slate-400", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-slate-400 mx-1 select-none", children: ">" }),
          /* @__PURE__ */ jsx("span", { className: "font-bold text-[#DF1818] tracking-tight", children: "Thane Branch" })
        ] }),
        /* @__PURE__ */ jsxs("h1", { className: "text-3xl sm:text-4xl lg:text-[50px] font-outfit font-extrabold tracking-tight text-[#1C3E8A] leading-[1.3] lg:leading-[1.6] mb-2", children: [
          "Amigo Academy",
          /* @__PURE__ */ jsx("br", {}),
          "Thane Branch"
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-slate-600 font-sans font-semibold text-xs sm:text-[16px] leading-relaxed max-w-xl", children: "Located in the heart of Thane, the Amigo Academy Thane Branch offers students convenient access to career-focused training in aviation and technology. Through practical learning, dedicated placement support, and honest career guidance, we help students take confident steps towards building successful professional careers." }),
    ...
    /* @__PURE__ */ jsx("section", { className: "sm:hidden relative w-full bg-white overflow-hidden border-b border-neutral-100", children: /* @__PURE__ */ jsxs("div", { className: "relative w-full h-[530px] overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "absolute inset-y-0 left-0 z-10 px-5 flex flex-col justify-center max-w-[280px]", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-[#475569] text-[12.5px] leading-relaxed mb-6 font-medium", children: "Located in the heart of Thane, the Amigo Academy Thane Branch gives students convenient access to career-focused training in aviation and technology. With practical learning, dedicated placement support, and honest career guidance, we help students take confident steps towards successful careers." }),
        /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("span", { children: "Visit the Thane Branch" }),
    ...
    /* @__PURE__ */ jsx("section", { className: "bg-white py-20 sm:py-24 border-t border-slate-50", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-6", children: /* @__PURE__ */ jsxs("div", { className: "max-w-[920px] mx-auto text-center", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-3xl sm:text-[40px] font-extrabold text-[#1C3E8A] font-outfit mb-8 leading-snug lg:leading-[1.5] tracking-tight", children: "Welcome to Thane Branch" }),
      /* @__PURE__ */ jsxs("div", { className: "space-y-5 text-slate-600 font-sans font-semibold text-xs sm:text-[16px] leading-relaxed", children: [
        /* @__PURE__ */ jsx("p", { children: "The Thane branch makes quality career-focused education more accessible to students across Thane and the surrounding areas. Whether you're planning a future in aviation or technology, our team is here to guide you through every stage of your journey\u2014from choosing the right course to preparing for your career." }),
        /* @__PURE__ */ jsx("p", { children: "At Amigo Academy, every branch follows the same commitment to practical learning, student support, and career-focused training, ensuring a consistent learning experience for every student." })
      ] })
    ] }) }) }),
    /* @__PURE__ */ jsx("section", { className: "bg-white py-16 sm:py-20 border-t border-slate-50", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-6 sm:px-8 md:px-12", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-3xl sm:text-[38px] font-extrabold text-[#1C3E8A] font-outfit mb-4 leading-tight tracking-tight", children: "Courses Offered at the Thane Branch" }),
        /* @__PURE__ */ jsx("p", { className: "text-slate-600 font-sans font-semibold text-xs sm:text-[15px] max-w-[640px] mx-auto leading-relaxed", children: "Students at our Thane branch can enrol in the same industry-focused programmes offered across all Amigo Academy locations." })
      ] }),
    ...
    /* @__PURE__ */ jsx("section", { className: "bg-white py-20 sm:py-24 border-t border-slate-50", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-6 sm:px-8 md:px-12", children: [
      /* @__PURE__ */ jsx("div", { className: "text-center mb-12", children: /* @__PURE__ */ jsx("h2", { className: "text-3xl sm:text-[40px] font-extrabold text-[#1C3E8A] font-outfit leading-tight tracking-tight", children: "Visit a Branch Before You Decide" }) }),
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "w-full h-[280px] sm:h-[360px] lg:h-[340px] rounded-[24px] overflow-hidden order-1 lg:order-2 shadow-[0_10px_30px_rgba(0,0,0,0.06)]", children: /* @__PURE__ */ jsx(
          ...
          {
            src: visitImg,
            alt: "Visit Amigo Academy Thane Branch",
            className: "w-full h-full object-cover"
          }
        ) })
      ] })
    ...
    /* @__PURE__ */ jsx("section", { className: "bg-[#f4f7fa] py-20 sm:py-24 border-t border-slate-100/60", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-6 sm:px-8 md:px-12", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-3xl sm:text-[40px] font-extrabold text-[#1C3E8A] font-outfit mb-12 text-center leading-tight tracking-tight", children: "Branch Information" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-[20px] p-7 border border-[#E1E5ED] shadow-[0_8px_30px_rgb(0,0,0,0.02)] hover:shadow-[0_12px_40px_rgb(0,0,0,0.05)] transition-all duration-300 flex flex-col gap-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxs("p", { className: "text-slate-500 font-sans text-xs sm:text-[13.5px] font-semibold leading-relaxed", children: [
              "A 204, 2nd floor, Thakor Niwas",
              /* @__PURE__ */ jsx("br", {}),
              "C.H.S, above Tip Top Mithaiwala,",
              /* @__PURE__ */ jsx("br", {}),
              "Thane West"
            ] })
          ] })
    ...
    /* @__PURE__ */ jsx("section", { className: "bg-[#001D4A] py-16 sm:py-20 text-center text-white relative overflow-hidden", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-6 flex flex-col items-center", children: [
      ...
      /* @__PURE__ */ jsx("h2", { className: "text-3xl sm:text-[44px] lg:text-[48px] font-extrabold text-white font-outfit max-w-3xl leading-tight tracking-tight mb-4", children: "Start Your Journey from the Branch That's Closest to You" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-[#1e293b]/40 border border-slate-700/50 rounded-xl px-5 py-2 inline-flex items-center gap-2 text-xs font-bold text-[#ffd300] uppercase tracking-wider mb-10", children: [
        /* @__PURE__ */ jsx("span", { children: "\u{1F3DB}" }),
...
const SplitComponent = ThaneBranch;

export { SplitComponent as component };
//# sourceMappingURL=thane-branch-jHP-Nifm.mjs.map
