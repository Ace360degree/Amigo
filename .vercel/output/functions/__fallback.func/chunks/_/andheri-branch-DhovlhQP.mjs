...
const andheriHero = "/assets/Andheri-hero-CM-cvIai.png";
const andheriHeroMobile = "/assets/Andheri-hero-mobile-DXPBeH2m.png";
const visitImg = "/assets/5-BIGiXS6M.png";
function AndheriBranch() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col bg-white", children: [
    /* @__PURE__ */ jsxs("section", { className: "hidden sm:flex relative w-full min-h-[620px] lg:h-[660px] bg-white items-center overflow-hidden border-b border-neutral-100", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "relative max-w-7xl mx-auto w-full px-6 sm:px-8 md:px-12 z-20 py-16 lg:py-0", children: /* @__PURE__ */ jsxs("div", { className: "max-w-[580px] lg:max-w-[650px] text-left flex flex-col space-y-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-xs sm:text-[13px] font-sans font-medium text-slate-400", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-slate-400 mx-1 select-none", children: ">" }),
          /* @__PURE__ */ jsx("span", { className: "font-bold text-[#DF1818] tracking-tight", children: "Andheri Branch" })
        ] }),
    ...
    /* @__PURE__ */ jsx("section", { className: "sm:hidden relative w-full bg-white overflow-hidden border-b border-neutral-100", children: /* @__PURE__ */ jsxs("div", { className: "relative w-full h-[530px] overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "absolute inset-y-0 left-0 z-10 px-5 flex flex-col justify-center max-w-[280px]", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-[#475569] text-[12.5px] leading-relaxed mb-6 font-medium", children: "Located in Andheri, our branch helps students build careers in Aviation and Technology through Certified courses training, practical learning, placement support, and personalised career guidance." }),
        /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("span", { children: "Visit the Andheri Branch" }),
    ...
    /* @__PURE__ */ jsx("section", { className: "bg-white py-20 sm:py-24 border-t border-slate-50", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-6", children: /* @__PURE__ */ jsxs("div", { className: "max-w-[920px] mx-auto text-center", children: [
      /* @__PURE__ */ jsxs("h2", { className: "text-3xl sm:text-[40px] font-extrabold text-[#1C3E8A] font-outfit mb-8 leading-snug lg:leading-[1.5] tracking-tight", children: [
        "Welcome To Amigo Academy",
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-5 text-slate-600 font-sans font-semibold text-xs sm:text-[16px] leading-relaxed", children: [
        /* @__PURE__ */ jsx("p", { children: "The Andheri branch of Amigo Academy is dedicated to helping students build successful careers in Aviation and Technology. Located in a well-connected area of Mumbai, this branch provides students with easy access to career-focused training, personalized guidance, and admission support." }),
        /* @__PURE__ */ jsx("p", { children: "Whether you are exploring career options after 12th or planning to enter the aviation or technology industry, our experienced team at Andheri is here to guide you with the right skills, knowledge, and confidence to make informed career decisions." })
      ] })
    ] }) }) }),
    /* @__PURE__ */ jsx("section", { className: "bg-white py-16 sm:py-20 border-t border-slate-50", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-6 sm:px-8 md:px-12", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-3xl sm:text-[38px] font-extrabold text-[#1C3E8A] font-outfit mb-4 leading-tight tracking-tight", children: "Courses Offered at the Andheri Branch" }),
        /* @__PURE__ */ jsx("p", { className: "text-slate-600 font-sans font-semibold text-xs sm:text-[15px] max-w-[640px] mx-auto leading-relaxed", children: "Students at our Andheri branch can enrol in the same industry-focused programmes offered across all Amigo Academy locations." })
      ] }),
    ...
    /* @__PURE__ */ jsx("section", { className: "bg-white py-20 sm:py-24 border-t border-slate-50", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-6 sm:px-8 md:px-12", children: [
      /* @__PURE__ */ jsx("div", { className: "text-center mb-12", children: /* @__PURE__ */ jsx("h2", { className: "text-3xl sm:text-[40px] font-extrabold text-[#1C3E8A] font-outfit leading-tight tracking-tight", children: "Visit Our Branch Before You Decide" }) }),
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center", children: [
        /* @__PURE__ */ jsxs("div", { className: "space-y-6 text-left order-2 lg:order-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-5 text-slate-600 font-sans font-semibold text-xs sm:text-[15px] leading-relaxed", children: [
            /* @__PURE__ */ jsx("p", { children: "Choosing the right institute is an important step towards building your future, and visiting our Andheri branch allows you to experience the Amigo Academy environment first-hand. Meet our counsellors, discuss your career goals, explore available courses, and receive honest guidance to help you select the right programme for your aspirations." }),
            /* @__PURE__ */ jsx("p", { children: "Whether you are visiting for admissions, course details, or career counselling, our team at the Andheri branch is here to answer your questions and support you throughout your journey towards a successful career in Aviation and Technology." })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "pt-2", children: /* @__PURE__ */ jsxs(
            "button",
            {
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-[20px] p-7 border border-[#E1E5ED] shadow-[0_8px_30px_rgb(0,0,0,0.02)] hover:shadow-[0_12px_40px_rgb(0,0,0,0.05)] transition-all duration-300 flex flex-col gap-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxs("p", { className: "text-slate-500 font-sans text-xs sm:text-[13.5px] font-semibold leading-relaxed", children: [
              "9th Floor, Time Chambers, S.V.Road,",
              /* @__PURE__ */ jsx("br", {}),
...
const SplitComponent = AndheriBranch;

export { SplitComponent as component };
//# sourceMappingURL=andheri-branch-DhovlhQP.mjs.map
