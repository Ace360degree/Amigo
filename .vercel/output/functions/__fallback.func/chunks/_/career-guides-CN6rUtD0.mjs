...
const careerHero = "/assets/careerguides-hero-DR_DOIoC.png";
const careermainMobile = "/assets/careermain-mobile-DwK6S-So.png";
const cardImg1 = "/assets/1-uDJQWdD9.png";
const cardImg2 = "/assets/2-aC-Ph-cy.png";
const cardImg3 = "/assets/3-D2Ye8znS.png";
const cardImg4 = "/assets/4-BOdZxm1m.png";
const cardImg5 = "/assets/5-CEd5L5Pl.png";
const cardImg6 = "/assets/6-DIGwV_xj.png";
const cardImg7 = "/assets/7-Mo7F9ExN.png";
const cardImg8 = "/assets/8-DrJfdeuT.png";
const guide12_1 = "/assets/12-1-C_dGG2Ac.png";
const guide12_2 = "/assets/12-2-jPBNKxKQ.png";
const guide12_3 = "/assets/12-3-Bt6ucsEp.png";
const guide12_4 = "/assets/12-4-BaLGdjwj.png";
const guide12_5 = "/assets/12-5-Bhakj_jb.png";
function CareerGuides() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col bg-white", children: [
    /* @__PURE__ */ jsxs("section", { className: "hidden sm:flex relative w-full min-h-[580px] lg:h-[620px] bg-white items-center overflow-hidden border-b border-neutral-100", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative max-w-7xl mx-auto w-full px-6 sm:px-8 md:px-12 z-20 py-16 lg:py-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-xs sm:text-[13px] font-sans font-medium text-slate-400", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "font-bold text-[#DF1818] tracking-tight", children: "Career Guides" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "max-w-xl lg:max-w-[680px] text-left flex flex-col space-y-6", children: [
          /* @__PURE__ */ jsx("h1", { className: "text-3xl sm:text-4xl lg:text-[50px] font-outfit font-extrabold tracking-tight text-[#1C3E8A] leading-snug sm:leading-[1.28] lg:leading-[1.32]", children: "Career Guides to Help You Make the Right Career Choice" }),
          /* @__PURE__ */ jsx("p", { className: "text-slate-600 font-sans font-semibold text-xs sm:text-[18px] leading-relaxed max-w-lg sm:max-w-xl", children: "Career Guides are designed to help you understand different professions before choosing a course. From eligibility and career growth to salary, industry insights, and career options after 12th, you'll find practical guidance that helps you make informed decisions with confidence." }),
    ...
    /* @__PURE__ */ jsx("section", { className: "sm:hidden relative w-full bg-white overflow-hidden border-b border-neutral-100", children: /* @__PURE__ */ jsxs("div", { className: "relative w-full h-[520px] overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "absolute inset-y-0 left-0 z-10 px-5 flex flex-col justify-center max-w-[310px]", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-xs font-sans font-medium text-slate-400 mb-3", children: [
          /* @__PURE__ */ jsx(Link, { to: "/", className: "hover:text-[#DF1818] transition-colors focus:outline-none", children: "Home" }),
          /* @__PURE__ */ jsx("span", { className: "text-slate-400 mx-1 select-none", children: ">" }),
          /* @__PURE__ */ jsx("span", { className: "font-bold text-[#DF1818] tracking-tight", children: "Career Guides" })
        ] }),
        /* @__PURE__ */ jsxs("h1", { className: "text-[32px] font-extrabold text-[#17365d] leading-[1.3] tracking-tight mb-4 font-outfit", children: [
          "Career Guides",
          /* @__PURE__ */ jsx("br", {}),
          "to Help You",
          /* @__PURE__ */ jsx("br", {}),
        ...
        /* @__PURE__ */ jsx("p", { className: "text-[#475569] text-[13px] leading-relaxed mb-6 font-medium max-w-[200px]", children: "Every successful career begins with the right training. At Amigo Academy, our industry-focused programmes in Cabin Crew, Airport Operations, and AI & Data Science equip students with practical skills, confidence, and career-ready expertise." }),
    ...
    /* @__PURE__ */ jsx("section", { className: "bg-white py-20 sm:py-24 border-t border-slate-50", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-6 text-center", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-3xl sm:text-[40px] font-extrabold text-[#1C3E8A] font-outfit mb-5 leading-tight tracking-tight", children: "Explore Career Guides" }),
      /* @__PURE__ */ jsx("p", { className: "text-slate-600 font-sans font-semibold text-xs sm:text-[15.5px] max-w-[820px] mx-auto mb-16 leading-relaxed", children: "If you've already decided which industry interests you, start by exploring one of our profession-specific Career Hubs. Each hub introduces the profession and brings together detailed guides covering eligibility, salary, required skills, career growth, interview preparation, and much more." }),
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-[24px] overflow-hidden border border-slate-100/80 shadow-[0_8px_30px_rgb(0,0,0,0.03)] hover:shadow-[0_12px_40px_rgb(0,0,0,0.07)] transition-all duration-300 flex flex-col justify-between text-left", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "relative w-full h-[210px] overflow-hidden", children: /* @__PURE__ */ jsx(
              "img",
              {
                src: cardImg1,
            ...
            /* @__PURE__ */ jsxs("div", { className: "p-6 sm:p-7 flex flex-col space-y-4", children: [
              /* @__PURE__ */ jsx("h3", { className: "text-[19px] sm:text-[21px] font-bold text-[#1C3E8A] font-outfit leading-snug", children: "Cabin Crew (Air Hostess) & Hospitality Management Career" }),
              /* @__PURE__ */ jsx("p", { className: "text-slate-500 font-sans text-xs sm:text-[13px] font-semibold leading-relaxed", children: "Thinking about becoming Cabin Crew? Explore everything you need to know about the profession\u2014from responsibilities and eligibility to salary, career growth, interview preparation, and industry insights." }),
              /* @__PURE__ */ jsxs("div", { className: "pt-2", children: [
                /* @__PURE__ */ jsx("h4", { className: "text-slate-400 font-sans font-bold text-[10.5px] sm:text-xs uppercase tracking-wider mb-3", children: "You'll Find Guides On" }),
                /* @__PURE__ */ jsx("ul", { className: "space-y-2", children: [
                  ...
                  "Job Opportunities"
                ].map((item, idx) => /* @__PURE__ */ jsxs("li", { className: "flex items-start text-xs sm:text-[13px] text-slate-600 font-bold", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-slate-400 mr-2.5 font-normal", children: "\u2022" }),
                  item
                ] }, idx)) })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "px-6 pb-7", children: /* @__PURE__ */ jsxs(
            "button",
            {
              onClick: () => {
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-[24px] overflow-hidden border border-slate-100/80 shadow-[0_8px_30px_rgb(0,0,0,0.03)] hover:shadow-[0_12px_40px_rgb(0,0,0,0.07)] transition-all duration-300 flex flex-col justify-between text-left", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "p-6 sm:p-7 flex flex-col space-y-4", children: [
              /* @__PURE__ */ jsx("h3", { className: "text-[19px] sm:text-[21px] font-bold text-[#1C3E8A] font-outfit leading-snug", children: "Airport Ground Staff Career" }),
              /* @__PURE__ */ jsx("p", { className: "text-slate-500 font-sans text-xs sm:text-[13px] font-semibold leading-relaxed", children: "Discover what it takes to build a successful career in airport operations. Learn about job roles, responsibilities, career opportunities, interviews, and the skills required to work in one of the aviation industry's most important professions." }),
              /* @__PURE__ */ jsxs("div", { className: "pt-2", children: [
                /* @__PURE__ */ jsx("h4", { className: "text-slate-400 font-sans font-bold text-[10.5px] sm:text-xs uppercase tracking-wider mb-3", children: "You'll Find Guides On" }),
                /* @__PURE__ */ jsx("ul", { className: "space-y-2", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-[24px] overflow-hidden border border-slate-100/80 shadow-[0_8px_30px_rgb(0,0,0,0.03)] hover:shadow-[0_12px_40px_rgb(0,0,0,0.07)] transition-all duration-300 flex flex-col justify-between text-left", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "p-6 sm:p-7 flex flex-col space-y-4", children: [
              /* @__PURE__ */ jsx("h3", { className: "text-[19px] sm:text-[21px] font-bold text-[#1C3E8A] font-outfit leading-snug", children: "AI & Data Science Career" }),
              /* @__PURE__ */ jsx("p", { className: "text-slate-500 font-sans text-xs sm:text-[13px] font-semibold leading-relaxed", children: "Explore one of today's fastest-growing industries through practical guides covering Artificial Intelligence, Data Science, career opportunities, learning pathways, and future industry demand." }),
              /* @__PURE__ */ jsxs("div", { className: "pt-2", children: [
                /* @__PURE__ */ jsx("h4", { className: "text-slate-400 font-sans font-bold text-[10.5px] sm:text-xs uppercase tracking-wider mb-3", children: "You'll Find Guides On" }),
                /* @__PURE__ */ jsx("ul", { className: "space-y-2", children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "bg-[#f4f7fa] py-20 sm:py-24 border-t border-slate-100/60", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-3xl sm:text-[40px] font-extrabold text-[#1C3E8A] font-outfit mb-5 text-center leading-tight tracking-tight", children: "Career Planning After 12th" }),
      /* @__PURE__ */ jsx("p", { className: "text-slate-600 font-sans font-semibold text-xs sm:text-[15.5px] max-w-[820px] mx-auto mb-10 text-center leading-relaxed", children: "Choosing what to do after 12th can feel overwhelming. These guides help you explore different career paths, compare opportunities, and understand which options best match your interests and future goals." }),
      /* @__PURE__ */ jsx("h3", { className: "text-2xl sm:text-[28px] font-bold text-[#1C3E8A] font-outfit text-center mb-12", children: "Explore These Guides" }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8", children: [
        ...
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "relative w-full h-[200px] overflow-hidden", children: /* @__PURE__ */ jsx(
              "img",
              {
                src: guide.img,
                alt: guide.title,
            ...
            /* @__PURE__ */ jsxs("div", { className: "p-6 sm:p-7 flex flex-col space-y-3.5", children: [
              /* @__PURE__ */ jsx("h3", { className: "text-[17px] sm:text-[19px] font-bold text-[#1C3E8A] font-outfit leading-snug", children: guide.title }),
              /* @__PURE__ */ jsx("p", { className: "text-slate-500 font-sans text-xs sm:text-[13px] font-semibold leading-relaxed", children: guide.desc })
            ] })
          ] })
        },
        idx
    ...
    /* @__PURE__ */ jsx("section", { className: "bg-white py-20 sm:py-24 border-t border-slate-50", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-3xl sm:text-[40px] font-extrabold text-[#1C3E8A] font-outfit mb-5 text-center leading-tight tracking-tight", children: "Career Comparisons & Industry Insights" }),
      /* @__PURE__ */ jsx("p", { className: "text-slate-600 font-sans font-semibold text-xs sm:text-[15.5px] max-w-[820px] mx-auto mb-12 text-center leading-relaxed", children: "Students often compare careers before making a decision. These guides help you understand the differences between professions, explore emerging career opportunities, and stay informed about industry trends." }),
      /* @__PURE__ */ jsx("h3", { className: "text-2xl sm:text-[28px] font-bold text-[#1C3E8A] font-outfit text-center mb-12", children: "Explore These Guides" }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8", children: [
        {
          img: cardImg4,
    ...
    /* @__PURE__ */ jsx("section", { className: "bg-[#f4f7fa] py-20 sm:py-24 border-t border-slate-100/60", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-6 text-center", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-3xl sm:text-[40px] font-extrabold text-[#1C3E8A] font-outfit mb-6 leading-tight tracking-tight", children: "Why Explore Our Career Guides?" }),
      /* @__PURE__ */ jsxs("div", { className: "max-w-[840px] mx-auto space-y-5 mb-16 text-slate-600 font-sans font-semibold text-xs sm:text-[15.5px] leading-relaxed", children: [
        /* @__PURE__ */ jsx("p", { children: "Choosing a career is a major decision, and having the right information makes all the difference. Our Career Guides answer the questions students ask us most often\u2014written in simple language, based on practical guidance, and designed to help you understand different career paths before choosing a course." }),
        /* @__PURE__ */ jsx("p", { children: "Whether you're exploring aviation or technology, these guides are here to help you make informed decisions before taking your next step." })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6", children: [
        ...
        "div",
        {
          ...
          children: /* @__PURE__ */ jsx("p", { className: "text-slate-600 font-sans text-xs sm:text-[14.5px] font-bold leading-relaxed", children: text })
        },
        idx
      )) })
    ] }) }),
    /* @__PURE__ */ jsx("section", { className: "bg-white py-20 sm:py-24 border-t border-slate-50", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-6", children: /* @__PURE__ */ jsxs("div", { className: "max-w-[840px] mx-auto flex flex-col items-center", children: [
      /* @__PURE__ */ jsxs("div", { className: "w-full text-center mb-12", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-3xl sm:text-[40px] font-extrabold text-[#1C3E8A] font-outfit mb-6 leading-tight tracking-tight", children: "Need Help Choosing the Right Career?" }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-5 text-slate-600 font-sans font-semibold text-xs sm:text-[15.5px] leading-relaxed", children: [
          /* @__PURE__ */ jsx("p", { children: "Every student has different interests, strengths, and aspirations. If you're still unsure which career path is the right fit, our counsellors are here to help." }),
          /* @__PURE__ */ jsx("p", { children: "We'll answer your questions honestly, explain your options, and help you understand which career and course best match your goals\u2014without unnecessary pressure." })
        ] })
      ] }),
...
const SplitComponent = CareerGuides;

export { SplitComponent as component };
//# sourceMappingURL=career-guides-CN6rUtD0.mjs.map
