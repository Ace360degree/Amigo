...
const _lazy_x24cq7 = () => import('../_/index.mjs');

const handlers = [
  { route: '/**', handler: _lazy_x24cq7, lazy: true, middleware: false, method: undefined }
];
...
export { eventHandler as e, listener as l, toWebRequest as t };
