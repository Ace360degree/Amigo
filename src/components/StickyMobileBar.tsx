  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 w-full bg-white border-t-2 border-[#0b2f61] shadow-[0_-6px_25px_rgba(0,0,0,0.15)]">
      <div className="grid grid-cols-3 w-full h-[65px]">
        ...
        >
          {/* WhatsApp Brand Icon */}
          <svg className="w-6 h-6 text-[#15803d] fill-current" viewBox="0 0 24 24">
          ...
          <span className="text-[12.5px] font-extrabold text-[#15803d] leading-tight mt-1 font-outfit tracking-wide">
            WhatsApp
          </span>
        </a>
