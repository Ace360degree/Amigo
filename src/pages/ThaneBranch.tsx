...
export default function ThaneBranch() {
  ...
  return (
    <div className="flex flex-col bg-white">
        ...
        <div className="relative max-w-7xl mx-auto w-full px-6 sm:px-8 md:px-12 z-20 py-16 lg:py-0">
          <div className="max-w-[580px] lg:max-w-[650px] text-left flex flex-col space-y-8">
            ...
            <div className="flex items-center gap-1.5 text-xs sm:text-[13px] font-sans font-medium text-slate-400">
              ...
              <span className="text-slate-400 mx-1 select-none">&gt;</span>
              <span className="font-bold text-[#DF1818] tracking-tight">Thane Branch</span>
            </div>
      ...
      {/* Welcome to Thane Branch section */}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-[920px] mx-auto text-center">
            ...
            <div className="space-y-5 text-slate-600 font-sans font-semibold text-xs sm:text-[16px] leading-relaxed">
              <p>
                The Thane branch makes quality career-focused education more accessible to students across Thane and the surrounding areas. Whether you're planning a future in aviation or technology, our team is here to guide you through every stage of your journey—from choosing the right course to preparing for your career.
              </p>
              <p>
                At Amigo Academy, every branch follows the same commitment to practical learning, student support, and career-focused training, ensuring a consistent learning experience for every student.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Courses Offered at the Thane Branch section */}
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 md:px-12">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-[38px] font-extrabold text-[#1C3E8A] font-outfit mb-4 leading-tight tracking-tight">
              Courses Offered at the Thane Branch
            </h2>
            <p className="text-slate-600 font-sans font-semibold text-xs sm:text-[15px] max-w-[640px] mx-auto leading-relaxed">
              Students at our Thane branch can enrol in the same industry-focused programmes offered across all Amigo Academy locations.
            </p>
          </div>
