...
const categories = [
  ...
  },
  {
    ...
    cards: [
      {
        image: cc3,
        title: "Airport Ground Staff Course Fees & Duration",
        meta: "Aug 10, 2026 • 5 min read"
      }
    ]
  },
    ...
    <div className="flex flex-col bg-white">
      ...
      <section className="bg-white py-20 sm:py-24 border-t border-slate-50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { label: "Career", value: "Airport Ground Staff" },
              { label: "Industry", value: "Aviation" },
              { label: "Eligibility", value: "12th Pass or Graduate" },
              { label: "Work Environment", value: "Domestic & International Airports" },
              { label: "Key Skills", value: "Customer Service, Communication & Operations" },
              { label: "Career Growth", value: "Managerial and supervisor roles within aviation" }
            ].map((item, idx) => (
              <div
                key={idx}
      ...
      <section className="w-full bg-white py-20 border-t border-slate-100">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 md:px-8 w-full flex flex-col items-center space-y-12">
          ...
          <div className="text-center space-y-4">
            <button
              onClick={handleCTA}
              className="inline-flex items-center justify-center gap-2 bg-[#DF1818] hover:bg-[#c41212] text-white font-sans font-bold text-[11px] sm:text-[13px] px-6 py-2.5 rounded-full shadow-[0_6px_16px_rgba(223,24,24,0.2)] hover:shadow-[0_10px_20px_rgba(223,24,24,0.3)] transition-all duration-300 active:scale-95 whitespace-nowrap focus:outline-none cursor-pointer mb-2"
            >
              Book Free Career Counselling &nbsp;➔
            </button>
