...
import ghatkoparHero from "../assets/img/branches/ghatkopar-hero.png";
import ghatkoparHeroMobile from "../assets/img/branches/ghatkopar-hero-mobile.png";
...
export default function GhatkoparBranch() {
  ...
  return (
    <div className="flex flex-col bg-white">
        ...
        <div className="relative max-w-7xl mx-auto w-full px-6 sm:px-8 md:px-12 z-20 py-16 lg:py-0">
          <div className="max-w-[580px] lg:max-w-[650px] text-left flex flex-col space-y-8">
            ...
            <div className="flex items-center gap-1.5 text-xs sm:text-[13px] font-sans font-medium text-slate-400">
              ...
              <span className="text-slate-400 mx-1 select-none">&gt;</span>
              <span className="font-bold text-[#DF1818] tracking-tight">Ghatkopar Branch</span>
            </div>

            <h1 className="text-3xl sm:text-4xl lg:text-[48px] font-outfit font-extrabold tracking-tight text-[#1C3E8A] leading-[1.3] lg:leading-[1.6] mb-2">
        ...
        <div className="relative w-full h-[530px] overflow-hidden">
          ...
          <div className="absolute inset-y-0 left-0 z-10 px-5 flex flex-col justify-center max-w-[280px]">
            ...
            <p className="text-[#475569] text-[12.5px] leading-relaxed mb-6 font-medium">
              Located in the heart of Ghatkopar, our branch has been helping students build careers in aviation and technology since 2017, with Certified courses aviation training, practical programmes, placement support, and honest career guidance.
            </p>
            ...
            <div>
              ...
              >
                <span>Visit the Ghatkopar Branch</span>
      ...
      {/* Welcome to Ghatkopar Branch section */}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-[920px] mx-auto text-center">
            <h2 className="text-3xl sm:text-[40px] font-extrabold text-[#1C3E8A] font-outfit mb-8 leading-snug lg:leading-[1.5] tracking-tight">
              Visit Our Ghatkopar Branch
            </h2>
            <div className="space-y-5 text-slate-600 font-sans font-semibold text-xs sm:text-[16px] leading-relaxed">
              <p>
                The Ghatkopar branch is the Head Office of Amigo Academy and has been at the centre of our journey since the academy was established in 2017. Conveniently located opposite Ghatkopar Railway Station, this branch provides students with easy access to career-focused training, personalised guidance, and admission support.
              </p>
              <p>
                Whether you're exploring your options after 12th or planning a career in aviation or technology, our team is here to help you make informed decisions with confidence.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Courses Offered at the Ghatkopar Branch section */}
      <section className="bg-white py-16 sm:py-20 border-t border-slate-50">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 md:px-12">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-[38px] font-extrabold text-[#1C3E8A] font-outfit mb-4 leading-snug lg:leading-[1.5] tracking-tight">
              Available Courses at Ghatkopar
            </h2>
            <p className="text-slate-600 font-sans font-semibold text-xs sm:text-[15px] max-w-[640px] mx-auto leading-relaxed">
              Students at our Ghatkopar branch can enrol in the same industry-focused programmes offered across all Amigo Academy locations.
            </p>
          </div>
      ...
      {/* Visit a Branch Before You Decide section */}
      <section className="bg-white py-20 sm:py-24 border-t border-slate-50">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 md:px-12">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-[40px] font-extrabold text-[#1C3E8A] font-outfit mb-8 leading-snug lg:leading-[1.5] tracking-tight">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-6 text-left order-2 lg:order-1">
              <div className="space-y-5 text-slate-600 font-sans font-semibold text-xs sm:text-[15px] leading-relaxed">
                <p>
                  Choosing the right institute is an important decision, and visiting our branch gives you the opportunity to experience Amigo Academy first hand. Meet our counsellors, discuss your career goals, understand the available courses, and get honest guidance to help you choose the programme that's right for you.
                </p>
                <p>
                  Whether you're visiting for admissions, course information, or career counselling, our team is here to answer your questions and support you throughout the process.
                </p>
              </div>
              <div className="pt-2">
                <button
      ...
      <section className="bg-[#f4f7fa] py-20 sm:py-24 border-t border-slate-100/60">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 md:px-12">
          <h2 className="text-3xl sm:text-[40px] font-extrabold text-[#1C3E8A] font-outfit mb-12 text-center leading-snug lg:leading-[1.5] tracking-tight">
            Frequently Asked Questions — Ghatkopar Branch
          </h2>
            ...
            <div className="bg-white rounded-[20px] p-7 border border-[#E1E5ED] shadow-[0_8px_30px_rgb(0,0,0,0.02)] hover:shadow-[0_12px_40px_rgb(0,0,0,0.05)] transition-all duration-300 flex flex-col gap-4">
              ...
              <div>
                ...
                <p className="text-slate-500 font-sans text-xs sm:text-[13.5px] font-semibold leading-relaxed">
                  ...
                  Opposite Railway Station, Pant<br />
                  Nagar, Ghatkopar East, Mumbai,<br />
                  Maharashtra &#8211; 400077
                </p>
              </div>
            </div>
      ...
      <section className="bg-[#001D4A] py-16 sm:py-20 text-center text-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 flex flex-col items-center">
          ...
          {/* Heading */}
          <h2 className="text-3xl sm:text-[44px] lg:text-[48px] font-extrabold text-white font-outfit max-w-3xl leading-snug lg:leading-[1.5] tracking-tight mb-4">
            Start Your Journey from Ghatkopar
          </h2>
